...
| [k8s-hardening.md](k8s-hardening.md) | Production-grade hardening (phase 1): secrets encryption-at-rest, audit logging, kubelet hardening, PodSecurity, kube-bench CIS scan |
